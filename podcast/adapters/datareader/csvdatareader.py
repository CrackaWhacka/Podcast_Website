...
class CSVDataReader:
    ...
    def __init__(self):
        ...
        self.podcast_csv_pathway = os.path.join(current_dir, '../data/podcasts.csv')
        self.episodes_csv_pathway = os.path.join(current_dir, '../data/episodes.csv')
    ...
    def create_podcast(self):
        ...
        for row in self.read_csv(self.podcast_csv_pathway):
            ...
            # If Row does not have the correct format or missing information then it will be skipped
                ...
                #Will add the podcast to the podcast list and sort the podcast list based on ID num
