...
def test_memory_repo_add_podcast(my_memory_repo,my_podcast):
    ...
    assert repr(type(my_memory_repo.get_podcast())) ==  "<class 'list'>"
    assert repr(my_memory_repo.get_podcast()[0]) == "<Podcast 100: 'Joe Toste Podcast - Sales Training Expert' by Joe Toste>"
